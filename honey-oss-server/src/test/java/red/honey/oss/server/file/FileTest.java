package red.honey.oss.server.file;
...
public class FileTest {
    ...
    public void fileUpload() {
        String pathName = "E:\\学习\\Java进阶\\05.dubbo快速学习 6课\\[www.javaxxz.com]01（传统架构图）.mp4";
    ...
    public void downAsUrl() {
        String url = fileService.downAsUrl(bucketName, "26ac87dd859f2f5b99859469d255d7a7");
        log.info(url);
    }
